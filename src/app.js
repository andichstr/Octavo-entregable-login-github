...
const port = 8080;
const MONGO_URL = "mongodb+srv://andischus:bienrustico19@andres-cluster.t8midx9.mongodb.net/ecommerce";
const SECRET_KEY = "alsdfjDsadjl12"
...
app.use(
  session({
    store: MongoStore.create({ mongoUrl: MONGO_URL, ttl: 86400 * 7 }),
    secret: SECRET_KEY,
    resave: true,
